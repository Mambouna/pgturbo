...
# NOTE: Above is the old implementation checking the Sphinx version with
# pkg_resources, but this was discontinued as a standard part of setuptools.
# Since Sphinx is by not in versions 9.+, we assume Sphinx>=1.3 is available
# and can thus simply set the theme directly.
html_theme = "alabaster"
